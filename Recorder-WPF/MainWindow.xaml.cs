...
namespace Microsoft.Samples.Kinect.ColorBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        private DrawingImage imageSourceSkeletal;
        ...
        private FrameDescription skeletalFrameDescription = null;
        ...
        public MainWindow()
        {
            ...
            this.bitmap = writer.Open("C:/Users/ASUS/Desktop/test.avi",30, 1920, 1080 );
            ...
            this.imageSourceSkeletal = new DrawingImage(this.drawingGroup); 
        ...
        public void InitializeSkeletalStream()
        {
            ...
            skeletalFrameDescription = this.kinectSensor.DepthFrameSource.FrameDescription;
            // get size of joint space
            this.displayWidth = this.skeletalFrameDescription.Width;
            this.displayHeight = this.skeletalFrameDescription.Height;
        ...
        public ImageSource ImageSourceSkeletal
        {
            get
            {
                return this.imageSourceSkeletal;
            }
        }
        ...
        {
            Console.WriteLine("dsadasdadsadasdasd");
            if (this.colorFrameReader != null)
            {
                ...
                if (colorFrame != null)
                {
                    ...
                    using (KinectBuffer colorBuffer = colorFrame.LockRawImageBuffer())
                    {
                        ...
                        if ((colorFrameDescription.Width == this.colorBitmap.PixelWidth) && (colorFrameDescription.Height == this.colorBitmap.PixelHeight))
                        {
                            ...
                            colorResolutionText.Content = "Resolution :  " + colorFrameDescription.Width.ToString() + "X" + colorFrameDescription.Height.ToString();
                ...
                if (depthFrame != null)
                {
                    ...
                    using (Microsoft.Kinect.KinectBuffer depthBuffer = depthFrame.LockImageBuffer())
                    {
                            ...
                            (this.depthFrameDescription.Width == this.depthBitmap.PixelWidth) && (this.depthFrameDescription.Height == this.depthBitmap.PixelHeight))
                        {
                            ...
                            depthResolutionText.Content = "Resolution :  " + depthFrameDescription.Width.ToString() + "X" + depthFrameDescription.Height.ToString();
                            skeletalResolutionText.Content = "Resolution :  " + depthFrameDescription.Width.ToString() + "X" + depthFrameDescription.Height.ToString();
        ...
        private void Reader_SkeletalFrameArrived(object sender, BodyFrameArrivedEventArgs e)
        {
            ...
            using (BodyIndexFrame bodyIndexFrame = e.FrameReference.AcquireFrame())
            {
                if (bodyIndexFrame != null)
                {
                    ...
                    using (Microsoft.Kinect.KinectBuffer bodyIndexBuffer = bodyIndexFrame.LockImageBuffer())
                    {
                        ...
                        {
                            indexResolutionText.Content = "Resolution :  " + bodyIndexFrameDescription.Width.ToString() + "X" + bodyIndexFrameDescription.Height.ToString();
